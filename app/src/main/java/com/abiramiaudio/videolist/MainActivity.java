...
import static com.abiramiaudio.videolist.DeveloperKey.DEVELOPER_KEY;
...
//            i.putExtra("KEY",videoId);
//            startActivity(i);

            SharedPreferences pref = getActivity().getSharedPreferences("MyKey", MODE_PRIVATE);
            SharedPreferences.Editor editor = pref.edit();
            editor.putString("key", videoId);
            editor.commit();
